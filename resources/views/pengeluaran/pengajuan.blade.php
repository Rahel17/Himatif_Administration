    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Pengajuan Pengeluaran</li>
            </ol>
        </nav>
    </div>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Ajuan Pengeluaran</h5>
                        <p class="card-text">Pengeluaran yang diajukan bendahara umum harus disetujui oleh kepala bagian
                            administrasi dan keuangan. Input dengan teliti agar tidak merugi</p>

                        <!-- Button untuk membuka modal -->
                        <button type="button" class="btn btn-info" data-bs-toggle="modal"
                            data-bs-target="#pengeluaranModal">
                            <i class="bi bi-file-diff"></i> Ajukan Pengeluaran
                        </button>
                        ...
                        <!-- Modal -->
                        <div class="modal fade" id="pengeluaranModal" tabindex="-1" aria-labelledby="pengeluaranModalLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-lg">
                                <!-- Tambahkan modal-lg untuk ukuran modal lebih besar -->
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="pengeluaranModalLabel">Ajukan Pengeluaran</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="{{ route('pengeluaran.store') }}" method="POST"
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <select class="form-select" id="inputKategori" name="pengeluaran"
                                                    required>
                                                    <option value="" selected disabled>Pilih Kategori</option>
                                                    <option value="proker"
                                                        {{ old('pengeluaran') == 'proker' ? 'selected' : '' }}>Proker
                                                    </option>
                                                    <option value="inventaris"
                                                        {{ old('pengeluaran') == 'inventaris' ? 'selected' : '' }}>Inventaris
                                                    </option>
                                                    <option value="lainnya"
                                                        {{ old('pengeluaran') == 'lainnya' ? 'selected' : '' }}>Lainnya
                                                    </option>
                                                </select>
                                                @error('pengeluaran')
                                                    <small class="text-danger">{{ $message }}</small>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped align-middle datatable">
                                ...
                                <tbody>
                                    @foreach ($pengajuanPengeluaran as $pengajuan)
                                        <tr>
                                            <td>{{ $loop->iteration }}</td>
                                            <td>{{ $pengajuan->tanggal }}</td>
                                            <td>{{ ucfirst($pengajuan->pengeluaran) }}</td>
                                                ...
                                                @elseif (auth()->user()->role === 'admin')
                                                    ...
                                                    @can('update', $pengajuan)
                                                        <div class="d-flex align-items-center">
                                                            <form
                                                                action="{{ route('pengeluaran.updateStatus', $pengajuan->id) }}"
